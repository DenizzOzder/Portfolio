      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-5xl relative z-10 flex flex-col items-center text-center">
        ...
        <p className="text-lg md:text-xl text-gray-300 leading-relaxed md:leading-[1.8] font-medium max-w-4xl mx-auto drop-shadow-md">
          <Trans
            ...
            components={[
              <span key="0" />,
              <span key="1" className="text-purple-300 font-bold drop-shadow-[0_0_15px_rgba(168,85,247,0.5)]" />,
              <span key="2" />,
              <span key="3" className="text-pink-300 font-bold drop-shadow-[0_0_15px_rgba(236,72,153,0.5)]" />,
              <span key="4" />,
              <span key="5" className="text-pink-300 font-bold drop-shadow-[0_0_15px_rgba(236,72,153,0.5)]" />
            ]}
          />
        </p>
