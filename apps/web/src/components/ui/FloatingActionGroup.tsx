export const FloatingActionGroup = () => {
  return (
    <>
      ...
      <div className="fixed left-4 bottom-0 z-50 flex flex-col items-center gap-6 hidden md:flex">
        <a 
          href="https://github.com/DenizzOzder" 
          target="_blank" 
          rel="noopener noreferrer"
          className="text-gray-400 hover:text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(255,255,255,0.5)] rounded-full"
          aria-label="GitHub"
        >
        ...
        <a 
          href="https://www.linkedin.com/in/denizcanozder/" 
          target="_blank" 
          rel="noopener noreferrer"
          className="text-gray-400 hover:text-[#0A66C2] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(10,102,194,0.5)] rounded-full"
          aria-label="LinkedIn"
        >
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
