...
export const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!accessKey) {
        toast.error('İletişim formu API anahtarı eksik. Lütfen site yöneticisiyle iletişime geçin.');
      ...
      if (result.success) {
        ...
        toast.error(result.message || 'Bir hata oluştu, lütfen daha sonra tekrar deneyin.');
      }
    } catch (error) {
