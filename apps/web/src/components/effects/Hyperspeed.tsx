...
export const hyperspeedPresets: Record<string, any> = {
  portfolio: {
    ...
    colors: {
      roadColor: 0x050010,
      islandColor: 0x0a001a,
      background: 0x050010,
      shoulderLines: 0x1a0b2e,
      brokenLines: 0x1a0b2e,
      leftCars: [0xd856bf, 0xec4899, 0xa855f7],
      rightCars: [0xa855f7, 0xec4899, 0x8b5cf6],
      sticks: 0xec4899
    }
  },
  one: {
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  return <div className="w-full h-full absolute inset-0 pointer-events-none" style={{ zIndex: 0 }} ref={hyperspeed}></div>;
};
