  ...
  return (
    <section className="relative w-full h-screen flex flex-col justify-center items-center text-center px-4 overflow-hidden">
        ...
        <div className="flex gap-6">
            <button className="px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-2xl font-bold shadow-lg shadow-purple-600/30 transition-all hover:scale-105">
                Projelerim
            </button>
            <button className="px-8 py-4 bg-transparent border border-gray-600 hover:border-purple-500 text-white rounded-2xl font-medium transition-all hover:bg-purple-900/20">
                İletişim
            </button>
        </div>
    </section>
