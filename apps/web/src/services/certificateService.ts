...
const mockCertificates: ProjectCardProps[] = [
  {
    ...
    techStack: [
      { name: 'React Native', iconName: 'react-original' },
      { name: 'Firebase', iconName: 'firebase-plain' },
    ],
  ...
  },
  {
    ...
    techStack: [
      { name: 'MongoDB', iconName: 'mongodb-plain' },
      { name: 'Express', iconName: 'express-original' },
      { name: 'React', iconName: 'react-original' },
      { name: 'Node.js', iconName: 'nodejs-plain' },
    ],
  ...
  },
  {
    ...
    techStack: [
      { name: 'TypeScript', iconName: 'typescript-plain' },
    ],
    projectUrl: '',
    status: 'completed',
  ...
  },
  {
    ...
    techStack: [
      { name: 'Amazon Web Services', iconName: 'amazonwebservices-plain-wordmark' },
    ],
    projectUrl: '#',
    actionLabel: 'Sertifikayı İncele \u2192',
    status: 'completed',
  ...
  },
  {
    ...
    techStack: [
      { name: 'Figma', iconName: 'figma-plain' },
    ],
    projectUrl: '#',
    actionLabel: 'Sertifikayı İncele \u2192',
    status: 'completed',
