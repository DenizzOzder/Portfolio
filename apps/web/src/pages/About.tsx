  ...
  return (
    <div className="w-full min-h-screen bg-[#050010] text-white overflow-hidden pb-24">
      ...
      <div className="relative w-full pt-40 pb-20 px-4 md:px-8 flex flex-col items-center justify-center text-center">
        ...
        <motion.h1 
          className="relative z-10 text-5xl md:text-7xl font-black leading-[1.4] bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-200 to-gray-400 tracking-tight drop-shadow-lg mb-6"
          initial="hidden"
          animate="visible"
